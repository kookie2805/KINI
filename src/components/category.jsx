...
const CategoryPage = () => {
  ...
  const Sekop = [
    {
      name: "Gembok Rumah",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219968/Gembok_SAP_40mm_long_zdsvvd.png",
      price: "Rp. 10.000",
    },
  ];
  ...
  const allProducts = [
    ...
    {
      name: "Meteran",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219970/Meteran_7.5m_Kofuku_ogcptf.png",
      price: "Rp. 20.000",
    },
    {
      name: "Isolasi",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219990/Isolasi_Nachi_il8kxz.png",
      price: "Rp. 30.000",
    },
    {
      name: "Pisau Kumis Mini",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219981/Pisau_Kumis_kecil_yvwuyl.png",
      price: "Rp. 40.000",
    },
    {
      name: "Pisau Kumis Besar",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219986/Pisau_kumis_Besar_qzlx8k.png",
      price: "Rp. 50.000",
    },
    {
      name: "Arit",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219990/Arit_GBK_r7adzr.png",
      price: "Rp. 60.000",
    },
    {
      name: "Piting Lampu Plfn",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219994/Piting_Lampu_plafon_ycbg1l.png",
      price: "Rp. 20.000",
    },
    {
      name: "Rantai Pacific",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735219990/Rantai_116_Pacific_6.7_speed_w7xexb.png",
      price: "Rp. 80.000",
    },
    {
      name: "Lem Auto Sealer",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220004/Lem_auto_sealer_Dextone_35_gr_sn6i0f.png",
      price: "Rp. 20.000",
    },
    {
      name: "Lem Pipa PVC",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220009/Lem_pipa_PVC_Qplast_rwelrp.png",
      price: "Rp. 25.000",
    },
    {
      name: "Mata Bor Kayu",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220011/Mata_Bor_kayu_set_Bison_bd5llj.png",
      price: "Rp. 35.000",
    },
    {
      name: "Kran Isco",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220015/Kran_merk_Isco_twoway_zvlrhd.png",
      price: "Rp. 12.000",
    },
    {
      name: "Cangkul",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220020/Cangkul_tanpa_merk_rbni8i.png",
      price: "Rp. 60.000",
    },
    {
      name: "Lem Alteco",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220027/Lem_Alteco_Korea_nautnb.png",
      price: "Rp. 9.000",
    },
    {
      name: "Piringan Kompor",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220028/piringan_Kompor_Gas_knbqaj.png",
      price: "Rp. 35.000",
    },
    {
      name: "Knop Kompor",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220028/Knop_Kompor_gas_cixpxd.png",
      price: "Rp. 14.000",
    },
    {
      name: "Pompa Sepeda",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220039/Pompa_sepeda_fjvagx.png",
      price: "Rp. 170.000",
    },
    {
      name: "Kunci Pas",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220040/Kunci_Pas_nesock.png",
      price: "Rp. 80.000",
    },
    {
      name: "Palu",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220046/Palu_c0phtu.png",
      price: "Rp. 90.000",
    },
    {
      name: "Tang",
      image: "https://res.cloudinary.com/ddl4sxrb3/image/upload/v1735220054/Tang_hml5cu.png",
      price: "Rp. 150.000",
    },
  ];
  ...
  // Fungsi untuk menangani klik menu kategori
  const handleProductClick = (productName) => {
    if (productName === "All Product") {
      setSelectedProduct(null); // Kosongkan pilihan jika kategori All Product dipilih
    } else {
      setSelectedProduct(products[productName]);
    }
  };
      ...
      <div className="w-[317px] h-[669px] bg-[#dedcdb] rounded-lg shadow-md p-4 ml-0 mb-9 mt-[-50px]">
        ...
        <div className="mt-4">
          <div
            ...
            onClick={() => handleProductClick("All Product")}
          >
